...
(function (factory) {
  ...
  var btnFixed = document.getElementsByClassName("myBtn")[0];
  var btnMobile = document.getElementsByClassName("myBtn")[1];
  var btnSticky = document.getElementsByClassName("myBtn")[2];
